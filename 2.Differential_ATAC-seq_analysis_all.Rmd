...
plot_sdc = function(x) {
  ...
  png(
  "/Users/Marta/Documents/WTCHG/DPhil/Plots/atac-seq/distance_matrix_voom_peaks.png",
  type = "cairo",
  width = 7,
  height = 5,
  units = "in",
...
spearman_cor = function(x){
  ...
  melted_cormat$X1 = factor(melted_cormat$X1,levels = paste(stages,samples,sep = "-"), ordered = T)
  melted_cormat$X2 = factor(melted_cormat$X2,levels = paste(stages,samples,sep = "-"), ordered = T)
  ...
  ggheatmap <- ggplot(melted_cormat, aes(X1, X2, fill = value)) +
    ...
    scale_x_discrete(breaks = c("iPSC-sbad3.1", "DE-sbad3.1","PGT-sbad3.1", "PFG-sbad3.1", "PE-sbad3.1",  "EP-sbad3.1", "EN-sbad3.1",  "BLC-sbad3.1"), labels = c("iPSC","DE", "GT", "PF", "PE" ,"EP","EN", "BLC")) +
    scale_y_discrete(breaks = c("iPSC-sbad3.1", "DE-sbad3.1","PGT-sbad3.1", "PFG-sbad3.1", "PE-sbad3.1",  "EP-sbad3.1", "EN-sbad3.1",  "BLC-sbad3.1"), labels = c("iPSC","DE", "GT", "PF", "PE" ,"EP","EN", "BLC")) +
  ...
  png(
  "/Users/Marta/Documents/WTCHG/DPhil/Plots/atac-seq/Spearman_cor.png",
  type = "cairo",
  width = 7,
  height = 5,
  units = "in",
...
pearson_cor = function(x){
 ...
 values = scales::rescale(c(0.4, 1.0)),
  ...
  png(
  "/Users/Marta/Documents/WTCHG/DPhil/Plots/atac-seq/Pearson_cor.png",
  type = "cairo",
  width = 7,
  height = 5,
  units = "in",
...
ggsave(
paste(
"/Users/Marta/Documents/WTCHG/DPhil/Plots/atac-seq/PCA_voom_atac-seq_",
currentDate,
".jpg",
sep = ""
),
...
sig_PGT_stage <-
combined_df[combined_df$stagesPGT.adj.P.Val < 0.01 &
maxVals == 3, c(5, 6)]
...
sig_PFG_stage <-
combined_df[combined_df$stagesPFG.adj.P.Val < 0.01 &
maxVals == 4, c(7, 8)]
