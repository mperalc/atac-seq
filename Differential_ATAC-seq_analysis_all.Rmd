...
I start the analysis from a file that contains the feature counts per peak and that has the following columns: Geneid,	Chr,	Start,	End,	Strand,	Length,	and each sample & differentiation stage.
...
counts <- read.table(file="/Users/Marta/Documents/WTCHG/DPhil/Data/Regulation/atac-seq/counts_all_samples_peaks_renamed.txt",header = T,check.names=F) # bed file with feature counts & info of start and end of peaks (all peaks present in at least one sample as detected by MACS2)
...
With this plot one should have enough information to chose the right CPM cutoff.
...
load(file="/Users/Marta/Documents/WTCHG/DPhil/Data/Regulation/atac-seq/session_objects/dge_atac-seq.xz",verbose=TRUE)  #loading again the dge object for conservative counts to do te selected QC
