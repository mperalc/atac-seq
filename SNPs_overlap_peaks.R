...
# general genome
annotate_whole_genome = function(){
  require(TxDb.Hsapiens.UCSC.hg19.knownGene)
  txdb <- TxDb.Hsapiens.UCSC.hg19.knownGene
...
GWASAnnotated = annotate_peaks_TxDb(credset.gr)
GWASAnnotated$anno = rownames(GWASAnnotated)
GWASAnnotated$type= "All SNPs in credible sets"

whole = annotate_whole_genome() # whole genome annotation
...
p = ggplot_stacked_barplot_percent(combined,pal )
