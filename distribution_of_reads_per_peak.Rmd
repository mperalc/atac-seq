...
new_counts=counts[7:ncol(new_counts)]

colnames(new_counts)=paste(names$stage,names$sample,sep="-")


#reorder columns by stages
ordered_stages=c("iPSC", "DE", "PGT", "PFG", "PE", "EP","ENstage6", "BLC")

order_by_stages=function(counts,stage.=ordered_stages){
...
new_counts=order_by_stages(new_counts)

new_counts=cbind(counts[1:6],new_counts)
